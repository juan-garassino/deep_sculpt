    ...
    cells.extend([
        ...
        },
        {
            ...
            "source": [
                ...
                ")\n",
                "\n",
                "# StyleGAN-inspired training strategy\n",
                "training_config.disc_steps = 2  # Train discriminator 2x per generator step\n",
                "training_config.use_r1_penalty = True  # R1 gradient penalty\n",
                "training_config.r1_gamma = 10.0\n",
                "\n",
    ...
    cells.extend([
        ...
        },
        {
            ...
            "source": [
                ...
                "\n",
                "# Stable Diffusion-inspired settings\n",
                "from core.training.pytorch_trainer import NoiseScheduler\n",
                "\n",
                "noise_scheduler = NoiseScheduler(\n",
                "    schedule_type='cosine',  # Cosine schedule (better than linear)\n",
                "    timesteps=CONFIG['timesteps'],\n",
                "    beta_start=0.00085,\n",
                "    beta_end=0.012,\n",
                "    device=CONFIG['device']\n",
                ")\n",
                "\n",
                "# Enable EMA for better sample quality\n",
                "training_config.use_ema = True\n",
                "training_config.ema_decay = 0.9999\n",
                "\n",
                ...
                "    device=CONFIG['device'],\n",
                "    prediction_type='v_prediction',  # V-prediction (more stable)\n",
                ")\n",
                "\n",
                "print('✅ Trainer ready')"
            ]
    ...
    cells.extend([
        ...
        },
        {
            ...
            "source": [
                ...
                "        # Use DDIM sampling (50 steps instead of 1000)\n",
                "        sample = trainer.sample_ddim(shape, num_inference_steps=50)\n",
                "        generated.append(sample.cpu())\n",
                "        torch.save(sample.cpu(), samples_dir / f'sample_{i:03d}.pt')\n",
                "        print(f'  Sample {i+1}/{CONFIG[\"num_eval_samples\"]} done')\n",
                "\n",
                "print(f'✅ Generated {len(generated)} samples')"
            ]
        },
